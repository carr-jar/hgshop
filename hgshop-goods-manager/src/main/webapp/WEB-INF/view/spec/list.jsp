  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="staticBackdropLabel">添加规格</h4>
         <button type="button" class="btn btn-light" onclick="addProp('#addspec')">添加属性</button>
        	...
        	<form id="addspec">
        		 <div class="form-group">
  				...
  				<div class="form-group form-group-proper">
    				...
    				<input type="text" name="options[0].optionName" class="form-control" id="inputAddress" placeholder="请输入规格属性">
...
<script type="text/javascript">
	...
	function addProp(fomId){
			$(fomId).append('<div class="form-group form-group-proper">'+
    				'<label for="inputAddress">属性值</label>'+
    				'<input type="text" name="options['+addindex+'].optionName" class="form-control" id="inputAddress" placeholder="请输入规格属性">'+
	...
	*/
	function refresh(){
		...
		var url="/spec/list?name=${queryName}"+'&pageNum=${p.pageNum}';
		$("#main").load(url);
	}
